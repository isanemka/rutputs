const guides = [
  {
    ...
    'description': 'Hur ofta bör du putsa fönster i Stockholm? Här går jag igenom rekommenderat intervall baserat på säsong, boendetyp och läge — med konkreta tips.',
    'h1': 'Hur ofta ska man putsa fönster?',
    'intro': 'Det korta svaret: två gånger per år för de flesta hem. Det långa svaret beror på var du bor, vilken typ av bostad du har och hur mycket pollen, trafik och regn dina fönster utsätts för.',
    ...
    'faq': [
      {
        ...
        'answer': 'För en villa i Stockholmsområdet rekommenderas två gånger per år — en gång på våren och en gång på hösten. Bor du nära mycket trafik eller har björkpollen i området kan tre gånger vara motiverat.',
        'linkLabel': 'Se priser för villa',
        'linkTo': '/tjanst/villa-fonsterputs'
      },
      {
        'question': 'Hur ofta ska man putsa fönster i en lägenhet?',
        'answer': 'I en lägenhet räcker det oftast med 1–2 gånger per år, beroende på våning och läge. Lägenheter mot innergård kan klara sig med en gång årligen, medan lägenheter mot trafikerad gata mår bra av två puts om året.',
        'linkLabel': 'Se priser för lägenhet',
        'linkTo': '/tjanst/lagenhet-fonsterputs'
      },
      {
        'question': 'När på året är det bäst att putsa fönster?',
        'answer': 'Bäst är slutet av april/början av maj och slutet av september. Då är det tillräckligt varmt för att vatten och putsmedel ska fungera bra, samtidigt som du får nytta av rena fönster under den ljusa delen av året.'
      },
      {
        'question': 'Kan man putsa fönster på vintern?',
        'answer': 'Ja, jag putsar fönster hela året — även i minusgrader. Vid lägre temperaturer använder jag ett specialmedel framtaget för vinterklimat, som är både effektivt och miljövänligt. Hör av dig så hittar jag en tid som passar.'
      },
      {
        'question': 'Hur lång tid håller en fönsterputs?',
        'answer': 'I normala fall syns smuts igen efter 3–6 månader, beroende på väder och läge. Hård regnsäsong eller mycket pollen kan korta intervallet.'
      }
    ],
    'relatedAreaSlugs': [
      'jarfalla',
  ...
  },
  {
    ...
    'description': 'Allt du behöver veta om RUT-avdrag för fönsterputs 2026: belopp, regler, hur det dras automatiskt och vad som gäller för villa, lägenhet och brf.',
    'h1': 'RUT-avdrag för fönsterputs 2026',
    'intro': 'Fönsterputsning är en av tjänsterna som omfattas av RUT-avdraget. Det betyder att du som privatperson får 50 % rabatt direkt på fakturan — jag sköter all administration mot Skatteverket.',
    'publishedAt': '2026-05-21',
    'readingTimeMin': 5,
    'author': 'Rutputs',
    'tags': [
    ...
    'faq': [
      {
        ...
        'answer': 'RUT-avdraget är 50 % av arbetskostnaden. Maxbeloppet per person och år är 75 000 kr i sammanlagd skattereduktion för RUT.'
      },
      {
        'question': 'Måste jag ansöka om RUT-avdraget själv?',
        'answer': 'Nej — jag som utförare drar av RUT direkt på fakturan och ansöker hos Skatteverket. Du behöver bara uppge ditt personnummer när du beställer.',
        'linkLabel': 'Begär offert',
        'linkTo': '/pris'
      },
      {
        'question': 'Gäller RUT-avdraget för min lägenhet?',
        'answer': 'Ja, RUT gäller för all fönsterputsning i din bostad oavsett om det är villa, bostadsrätt eller hyresrätt.',
        'linkLabel': 'Fönsterputs för lägenhet',
        'linkTo': '/tjanst/lagenhet-fonsterputs'
      },
      {
        'question': 'Kan en bostadsrättsförening använda RUT?',
        'answer': 'Nej, RUT-avdraget är personligt och kan bara användas av fysiska personer. En BRF betalar fullt pris för gemensamma ytor, men enskilda medlemmar kan använda RUT för putsning i den egna lägenheten.'
      },
      {
        'question': 'Vad händer om jag har för lite skatt att kvitta mot?',
        'answer': 'Då måste du betala mellanskillnaden till Skatteverket i samband med slutskattebeskedet. Det är därför bra att uppskatta sin inkomst innan man använder upp hela RUT-taket.'
      },
      {
        'question': 'Räknas resor och material in i RUT-avdraget?',
        'answer': 'Nej, bara arbetskostnaden omfattas av RUT. Eventuella materialkostnader och reseersättning ligger utanför.'
      }
    ],
    'relatedServiceSlugs': [
      'villa-fonsterputs',
    ...
    'faq': [
      {
        ...
        'answer': 'Det rekommenderas att använda milt diskmedel eller specialmedel för fönsterputs för att undvika skador på glaset.',
        'linkLabel': 'Läs mer om fönsterputsning.',
        'linkTo': '/tjanst/lagenhet-fonsterputs'
      },
      {
        'question': 'Hur ofta ska jag tvätta min inglasade balkong?',
        'answer': 'En gång per säsong är en bra riktlinje, men om du bor i områden med mycket pollen, som Nacka, kan det vara bra att tvätta oftare.',
      ...
      },
      {
        ...
        'answer': 'Ja, Rutputs erbjuder professionell fönsterputsning och balkongrengöring i hela Stockholm.',
        'linkLabel': 'Ta kontakt för mer information.',
        'linkTo': '/pris'
      },
      {
        'question': 'Vad kostar det att anlita fönsterputsning?',
        'answer': 'Priserna varierar beroende på storlek och typ av fönster. Du kan enkelt be om en offert genom formuläret. ',
        'linkLabel': 'Be om en gratis offert.',
        'linkTo': '/pris'
      }
    ],
    'relatedAreaSlugs': [
